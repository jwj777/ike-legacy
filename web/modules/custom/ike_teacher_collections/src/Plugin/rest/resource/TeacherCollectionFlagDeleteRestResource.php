 ...
 *
 * @RestResource(
 *   id = "teacher_collection_flag_delete_rest_resource",
 *   label = @Translation("Teacher collection flag delete rest resource"),
 *   uri_paths = {
 *     "create" = "/api/teacher-collection-flag/delete"
 *   }
 * )
 */
class TeacherCollectionFlagDeleteRestResource extends ResourceBase {
   ...
   *
   * @param Symfont\Component\HttpFoundation\Request $request
   *   The request object.
   *
  ...
  public function post(Request $request) {
    ...
    if ($flag) {
      // See if entity is already flagged, if so we unflag it.
