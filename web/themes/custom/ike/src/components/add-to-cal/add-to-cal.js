 ...
 *
 * Modified to change some labels and layout
 */
; (function (exports) {
  ...
  var calendarGenerators = {
    google: function (event) {
      ...
      return '<a class="atcb-item-link" target="_blank" href="' +
        href + '">Google</a>';
    },
    ...
    ical: function (event) {
      return this.ics(event, 'atcb-item-link', 'Apple');
    },

    outlook: function (event) {
      return this.ics(event, 'atcb-item-link', 'Outlook');
    }
  };
